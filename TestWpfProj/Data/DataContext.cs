...
namespace TestWpfProj.Data
{
    public static class DataContext
    {
        ...
        {
            new Meme("Megusto", MemeTypes[2]),
            new Meme("bruh", MemeTypes[1]),
            new Meme("Omsk", MemeTypes[2]),
            new Meme("MalishkaHochetSdatPraktiku", MemeTypes[0]),
            new Meme("Sigma", MemeTypes[1])
        };
    }
}
